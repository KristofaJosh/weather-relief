...
import {getSingleCity, refreshWeather} from "../../../store/reducers/weather/weatherSlice";
import {setLargestCity} from "../../../store/reducers/favourites/favouriteSlice";
        ...
        >
          <div className={style.currentLocation__lastUpdate}>
            <Typography level={"f12"} className={"small"}>
              ...
              {new Date(
                myLocation.location.localtime.replace(" ", "T")
              ).toDateString()}
              {" - "}
